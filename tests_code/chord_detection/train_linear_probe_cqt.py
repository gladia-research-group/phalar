...
# Load dataset
with open('guitarset_chroma_cqt_embeddings_dataset.pkl', 'rb') as f:
...
class ChordPredictionHead(nn.Module):
    def __init__(self, input_dim=12, output_dim=25):
...
for k in range(K):
    ...
    # Initialize model
    model = ChordPredictionHead(input_dim=12, output_dim=25).cuda()
